        ...
        <ThemedView className="gap-8 mt-10">
          <ThemedView className="border-b border-b-zinc-400">
            ...
            <TextInput
              ...
              className="text-white rounded-lg border-b border-b-zinc-400 px-2 py-1 mt-1"
          ...
          <ThemedView className="border-b border-b-zinc-400">
            ...
            <TextInput
              ...
              className="text-white rounded-lg px-2 py-1 mt-1"
              placeholderTextColor="gray"
              secureTextEntry={true}
            />
          </ThemedView>
        </ThemedView>
        <Text className="mt-8 text-center text-blue-500">Forgot Password?</Text>
