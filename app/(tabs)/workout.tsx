  ...
  return (
    <View className="flex-1 pt-6 px-2">
      ...
      <Pressable
        ...
        className="w-full flex-row gap-4 bg-zinc-800 items-center px-4 py-3 rounded-lg mt-4"
      >
      ...
      <View className="flex-row w-full items-center justify-between">
        <Pressable
          ...
          className="w-[47%] flex-row gap-4 bg-zinc-800 items-center px-4 py-3 rounded-lg mt-4"
        >
